      ...
      {hasHsaPlan && (
        <>
          ...
          <Callout tone="neutral">
            <Trans
              i18nKey="contributionGauges.hsaExplainer"
              components={{ b: <strong /> }}
            >
              <b>Why the HSA sits inside the retirement balance here.</b> After
              65 it behaves like a traditional retirement account — withdrawals
              for anything are taxed as income, and medical withdrawals stay
              tax-free at any age. Contributions avoid income tax and payroll
              tax on the way in, growth is untaxed, and qualified withdrawals
              are untaxed on the way out. That triple advantage is why maxing it
              is a reasonable target, and why it is counted as long-term money
